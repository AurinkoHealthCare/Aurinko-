  ...
  const fetchHeaderImage = async () => {
    try {
      ...
      const selected = arr.find(
        (img) => img.imageName?.toLowerCase() === "health supplements"
      );
      ...
      <div className="relative w-full">
        {loadingHeader ? (
          ...
          <div className="relative w-full">
            ...
            />
            <div className="absolute inset-0 p-4 items-center text-[#b30800]">
          ...
          <div className="w-full h-64 flex items-center justify-center bg-gray-100">
            <p className="text-gray-500">No "Health supplements" image found</p>
          </div>
        )}
      </div>
