...
// import poultry_data from "../../Data/poultry_data.jsx";
  ...
  return (
    <div className="font-sans">
      <div className="relative">
        <img
          src="/Assets/veterinary/Poultry.webp"
          alt="Poultry"
          className="w-full"
        />
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-2">
          <h1 className="lg:text-4xl font-bold">Poultry</h1>
        </div>
      </div>
      {/* <div className="flex flex-col min-h-screen w-full p-4">
        {poultry_data?.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-4">
            {poultry_data.map((product) => (
