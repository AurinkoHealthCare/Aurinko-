  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 py-20 gap-16">
      ...
      <div className="w-full lg:w-1/2 text-center space-y-6">
        <h1 className="text-4xl font-extrabold text-green-600">Review & Feedback</h1>
        <div className="h-1 w-48 bg-gradient-to-r from-green-500 to-green-600 rounded-full mx-auto" />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <motion.img
                ...
                className="w-24 h-24 rounded-full border-4 border-green-400 shadow-lg mb-4 object-cover"
