...
const Block6 = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between px-6 md:px-16 mt-7 pb-20 gap-16">

      {/* LEFT */}
      <div className="w-full lg:w-1/2 space-y-8 text-center lg:text-left">
        <h1 className="text-4xl font-extrabold text-[#01421d] uppercase">
          {t("block6.getInTouch")}
        </h1>
        <div className="h-1 w-40 bg-gradient-to-r from-green-600 to-[#01421d] rounded-full mx-auto lg:mx-0" />

        <p className="text-gray-700 text-base md:text-lg leading-relaxed">
          {t("block6.healthMessage")}
        </p>

        <Link to="/agriculture/contact_us" onClick={(e) => reloadPage(e, "/agriculture/contact_us")}>
      ...
      <div className="w-full lg:w-1/2 text-center space-y-6">
        ...
        <div className="flex items-center justify-center mt-6">
          <AnimatePresence mode="wait">
            <motion.div
              key={currentIndex}
              className="w-80 h-96 bg-white/80 backdrop-blur-md border border-[#01421d] shadow-2xl rounded-3xl p-6 flex flex-col items-center justify-center transition-all duration-500"
            ...
            >
              <motion.img
                ...
                className="w-24 h-24 rounded-full border-4 border-[#01421d] shadow-lg mb-4 object-cover"
              ...
              <h3 className="mt-4 text-lg font-semibold text-[#01421d]">
