  ...
  return (
    <div className={`font-sans ${theme === "dark" ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
      <div className="relative">
        <img
          src="/Assets/Nano-biotechnology Compounds/Nanophosphosome.webp"
      ...
      <div className="flex flex-col w-full p-4">
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-1 gap-4">
          <ProductCard products={products} segment="ANanophosphosome" theme="Agriculture" />
        </div>
      </div>
    </div>
  );
...
export default ANanophosphosome;